            ...
            <div className='container product-detail'>
                ...
                <div className='row mb-5'>
                    ...
                    <div className='col-md-7'>
                        ...
                        <div>
                            100% Original Products <br /> Pay on Delivery might be available. <br /> Easy 15 Days Returns and exchanges
                        </div>
                        ...
                        <div className='add-to-card my-4'>
                            <button className='btn btn-primary text-uppercase'>Add To Card</button>
                        </div>
                        <hr />
