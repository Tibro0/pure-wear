...
const Show = () => {
    useEffect(() => {
        document.title = "Admin | All Sizes";
    }, []);
            ...
            <div className='container'>
                <div className='row'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        <h4 className='h4 pb-0 mb-0'>Sizes</h4>
                        <Link to='/admin/sizes/create' className='btn btn-primary'>Create</Link>
                    </div>
                    ...
                    <div className='col-md-9'>
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && sizes.length == 0 && <Nostate text='Sizes Not Found!' />
                                }
